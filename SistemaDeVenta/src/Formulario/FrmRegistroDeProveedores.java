...
public class FrmRegistroDeProveedores extends JInternalFrame {
	/**
	 * 
	 */
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmRegistroDeProveedores frame = new FrmRegistroDeProveedores();
	...
	public void INITIALIZE() {
		...
		tabbedPane.addTab("Proveedores", new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/probeedores.png")), panel, null);
		...
		btnAgregarCiudad.setIcon(new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/B7D02FDEF.png")));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////FIN	
		...
		label_3.setIcon(new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/imagen.png")));
		...
		btnGenerarCodigoProveedor.setIcon(new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/902BCB3FC.png")));
		...
		tabbedPane.addTab("Busqueda de Proveedores", new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/6B6F6D5EB.png")), panel_1, null);
		...
		txtBuscarPorCodigo.setBounds(157, 3, 180, 26);
		...
		btnBuscar.setIcon(new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/E937E1E0B.png")));
		...
		label_1.setIcon(new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/1967D602A.png")));
		...
		JLabel lblAdministracionDeUsuarios = new JLabel("Administracion de Proveedores");
		...
		btnNuevoProveedor.setIcon(new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/nuevo.png")));
		...
		btnAgregarProveedor.setIcon(new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/157809D10.png")));
		...
		btnCancelar.setIcon(new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/abort.png")));
		...
		btnSalir.setIcon(new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/salir.png")));
		...
		btnEditar.setIcon(new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/D1F0AC18D.png")));
		...
		btnGuardar.setIcon(new ImageIcon(FrmRegistroDeProveedores.class.getResource("/Recursos/guardar.png")));
